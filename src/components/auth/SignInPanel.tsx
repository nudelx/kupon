      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <div className="card-body">
            <button type="button" className="btn btn-outline" onClick={handleGoogleSignIn} disabled={isGoogleRedirecting}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24" height="24">
                ...
                <path
                  fill="#1976D2"
                  d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.574l6.19 5.238C44.902 35.126 48 30.028 48 24c0-1.341-.138-2.65-.389-3.917z"
                />
              </svg>
